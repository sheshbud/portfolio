...
**Medtronic** — Product Security Intern (June 2026 – Present), Boston, MA
...
**Microsoft** — AI Student Ambassador & WICxDevSecOps Program Participant (Oct 2025 – Feb 2026), Boston, MA
...
**Medtronic** — R&D Software Engineering Intern (June–Aug 2025, July–Aug 2024), North Haven, CT
...
**Secure & Assured Intelligent Learning Lab** — Cybersecurity & Safety Researcher (June 2023 – Feb 2024), New Haven, CT
Identified 8 security vulnerabilities in LLM systems through 50+ prompt injection attacks.

**KPMG** — Summer Intern, Audit/Tax/Advisory Accounting (July–Aug 2023), Hartford, CT
...
**Gurls Chess Club Non-Profit** — Founder, Executive Director & TEDx Speaker (Dec 2021 – Present)
...
- Independent, uncoordinated interference is — 0→4 disruptors took latency from 3ms to 33ms while packet loss stayed at zero.
- Degradation compounds non-linearly — +112% latency at 1→2 disruptors, +209% at 2→4.
...
**Also explored:** a decentralized ESP-NOW-based variant for direct device-to-device communication with no access point — worked, though the lack of a retry layer meant ~9% packet loss, pointing at the next research direction.
