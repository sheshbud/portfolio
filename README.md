...
Built Python tooling to capture and visualize WiFi packet loss across 2.4/5 GHz bands for medical device security research; analyzed wireless attack surfaces and developed developer security training.
